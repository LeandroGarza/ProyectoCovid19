...
class DatosPaciente{
  ...
  public:
      ...
      friend bool operator== (const DatosPaciente& d1, const DatosPaciente& d2);
      friend bool operator!= (const DatosPaciente& d1, const DatosPaciente& d2);
      friend bool operator>= (const DatosPaciente& d1, const DatosPaciente& d2);
      friend bool operator> (const DatosPaciente& d1, const DatosPaciente& d2);
      friend bool operator<= (const DatosPaciente& d1, const DatosPaciente& d2);
      friend bool operator< (const DatosPaciente& d1, const DatosPaciente& d2);
      friend bool operator! (const DatosPaciente& d1);
...
bool operator== (const DatosPaciente& d1, const DatosPaciente& d2){
...
bool operator! (const DatosPaciente& d1){
  return !d1.buscado;
};
...
string DatosPaciente::get_fecha_inicio_sintomas(){
...
string DatosPaciente::get_fecha_fallecimiento(){
  return fecha_fallecimiento;
};
string DatosPaciente::get_clasif(){
  return clasif;
};
string DatosPaciente::get_fecha_diagnostico(){
  return fecha_diagnostico;
};

bool DatosPaciente::get_buscado(){
  return buscado;
}
...
void DatosPaciente::set_sexo(string c){
  sexo = c;
};
...
void DatosPaciente::set_fecha_inicio_sintomas(string s){
...
void DatosPaciente::set_fecha_fallecimiento(string s){
  fecha_fallecimiento = s;
};
void DatosPaciente::set_clasif(string s){
  clasif = s;
};
void DatosPaciente::set_fecha_diagnostico(string s){
  fecha_diagnostico = s;
};

void DatosPaciente::set_buscado(bool b){
  buscado = b;
}
